    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="/dashboard/role" class="nav-link">Role</a>
          </li>
          <li class="nav-item">
            <a href="/dashboard/infoloker" class="nav-link">Lowongan Kerja</a>
          </li>
          <li class="nav-item">
            <a href="/dashboard/infoloker" class="nav-link">Lamaran</a>
          </li>
        </ul>
